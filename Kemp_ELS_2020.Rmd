...
## Raw Data
The original sequencing reads are available for download via NCBI’s Sequence Read Archive under Bioproject PRJNA605008.
...
taxon <- read.table("_bin/silva_taxa_table.txt",sep="\t",header=TRUE,row.names=1)
